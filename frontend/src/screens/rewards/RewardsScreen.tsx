...
const styles = StyleSheet.create({
  ...
  tabBar: { flexDirection: 'row', backgroundColor: colors.card, borderBottomWidth: 1, borderBottomColor: '#2a2a4e' },
  ...
  tierText: { color: colors.text, fontWeight: '600', marginLeft: 6 },
  pointsValue: { fontSize: 48, fontWeight: '700', color: colors.text, marginTop: 12 },
  ...
  streakCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.card, borderRadius: 12, padding: 16, marginBottom: 16, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  activityRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.card, borderRadius: 12, padding: 16, marginBottom: 8, borderWidth: 1, borderColor: '#2a2a4e' },
  activityInfo: { flex: 1 },
  ...
  badgeCard: { width: '47%', backgroundColor: colors.card, borderRadius: 12, padding: 16, alignItems: 'center', position: 'relative', borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  leaderboardRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.card, borderRadius: 12, padding: 16, marginBottom: 8, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  leaderName: { flex: 1, fontSize: 16, color: colors.text },
