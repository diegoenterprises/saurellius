...
const styles = StyleSheet.create({
  ...
  generateButton: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.card, paddingHorizontal: 14, paddingVertical: 8, borderRadius: 8, borderWidth: 1, borderColor: '#1473FF' },
  ...
  ytdValue: { fontSize: 20, fontWeight: '700', color: colors.text, marginTop: 4 },
  ...
  paystubCard: { backgroundColor: colors.card, borderRadius: 12, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  paystubHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16 },
  payDate: { fontSize: 16, fontWeight: '600', color: colors.text },
  ...
  paystubAmounts: { flexDirection: 'row', backgroundColor: colors.background, borderRadius: 8, padding: 12, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  amountValue: { fontSize: 18, fontWeight: '600', color: colors.text },
