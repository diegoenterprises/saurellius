...
const styles = StyleSheet.create({
  ...
  section: {
    maxWidth: 1200,
    width: '100%',
    alignSelf: 'center', backgroundColor: colors.card, borderRadius: 12, marginHorizontal: 16, overflow: 'hidden', borderWidth: 1, borderColor: '#2a2a4e' },
  profileSection: { backgroundColor: colors.card, borderRadius: 12, marginHorizontal: 16, padding: 20, borderWidth: 1, borderColor: '#2a2a4e', flexDirection: 'row', alignItems: 'center' },
  ...
  profilePictureInitials: { fontSize: 28, fontWeight: '700', color: colors.text },
