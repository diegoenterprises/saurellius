...
const styles = StyleSheet.create({
  ...
  portfolioCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  itemTitle: { fontSize: 18, fontWeight: '600', color: colors.text, marginBottom: 6 },
