...
const styles = StyleSheet.create({
  ...
  ratingValue: { fontSize: 36, fontWeight: 'bold', color: colors.text },
  ...
  reviewCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  reviewTitle: { fontSize: 15, fontWeight: '600', color: colors.text, marginBottom: 6 },
  ...
  reviewPreview: { backgroundColor: colors.card, borderRadius: 12, padding: 14, marginBottom: 16 },
  previewName: { fontSize: 14, fontWeight: '600', color: colors.text, marginBottom: 4 },
