...
const styles = StyleSheet.create({
  ...
  scheduleCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  createInvoiceText: { fontSize: 13, fontWeight: '600', color: colors.text },
