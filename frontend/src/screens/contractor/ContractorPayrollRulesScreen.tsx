...
export default function ContractorPayrollRulesScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}> 
      <ScrollView contentContainerStyle={styles.content}>
        <Text style={[styles.title, { color: colors.text }]}>Rules (Contractor)</Text>
        <Text style={[styles.subtitle, { color: colors.textSecondary }]}>Platform rulesets are still visible for transparency (even though 1099 payments do not use withholding).</Text>
