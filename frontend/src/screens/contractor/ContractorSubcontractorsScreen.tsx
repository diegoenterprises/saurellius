...
const styles = StyleSheet.create({
  ...
  subCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  subStatValue: { fontSize: 15, fontWeight: '600', color: colors.text },
