...
const styles = StyleSheet.create({
  ...
  heroMetaValue: { fontSize: 16, fontWeight: '600', color: colors.text },
  heroMetaLabel: { fontSize: 11, color: '#a0a0a0', marginTop: 2 },
  rangeSelector: { flexDirection: 'row', marginHorizontal: 16, marginVertical: 12, backgroundColor: colors.card, borderRadius: 10, padding: 4 },
  ...
  chartCard: { backgroundColor: colors.card, marginHorizontal: 16, marginTop: 12, borderRadius: 14, padding: 16 },
  ...
  sectionCard: { backgroundColor: colors.card, marginHorizontal: 16, marginTop: 12, borderRadius: 14, padding: 16 },
  ...
  clientInitial: { fontSize: 14, fontWeight: 'bold', color: colors.text },
  ...
  typeAmount: { width: 70, fontSize: 13, fontWeight: '500', color: colors.text, textAlign: 'right' },
  ...
  projectionValue: { fontSize: 20, fontWeight: 'bold', color: colors.text },
  ...
  taxCard: { backgroundColor: colors.card, marginHorizontal: 16, marginTop: 12, borderRadius: 14, padding: 16 },
  taxHeader: { flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 12 },
  taxTitle: { fontSize: 16, fontWeight: '600', color: colors.text },
  taxRow: { flexDirection: 'row' },
  taxItem: { flex: 1, alignItems: 'center' },
  taxValue: { fontSize: 18, fontWeight: 'bold', color: colors.text },
