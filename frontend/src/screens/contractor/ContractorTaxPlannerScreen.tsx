...
const styles = StyleSheet.create({
  ...
  estimateCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, borderWidth: 1, borderColor: '#2a2a4e' },
  estimateTitle: { fontSize: 18, fontWeight: '600', color: colors.text, marginBottom: 16 },
  ...
  incomeValue: { fontSize: 14, fontWeight: '500', color: colors.text },
  ...
  totalTaxLabel: { fontSize: 15, fontWeight: '600', color: colors.text },
  totalTaxValue: { fontSize: 18, fontWeight: 'bold', color: '#EF4444' },
  rateBox: { backgroundColor: colors.background, padding: 14, borderRadius: 10, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  rateLabel: { fontSize: 14, color: '#a0a0a0' },
  rateValue: { fontSize: 20, fontWeight: 'bold', color: '#F59E0B' },
  paymentCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  quarterText: { fontSize: 16, fontWeight: 'bold', color: colors.text },
  quarterYear: { fontSize: 10, color: 'rgba(255,255,255,0.7)' },
  paymentInfo: { flex: 1 },
  paymentAmount: { fontSize: 18, fontWeight: '600', color: colors.text },
  ...
  payButtonText: { fontSize: 14, fontWeight: '600', color: colors.text },
  deductionCategory: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  deductionAmount: { fontSize: 13, fontWeight: '500', color: colors.text },
