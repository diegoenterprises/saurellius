...
const styles = StyleSheet.create({
  ...
  statCardValue: { fontSize: 20, fontWeight: 'bold', color: colors.text },
  ...
  templateCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 14, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  useText: { fontSize: 14, fontWeight: '600', color: colors.text },
  ...
  createText: { fontSize: 14, fontWeight: '600', color: colors.text },
});
