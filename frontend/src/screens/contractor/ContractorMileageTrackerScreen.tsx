...
const styles = StyleSheet.create({
  ...
  mainStatValue: { fontSize: 28, fontWeight: 'bold', color: colors.text, marginTop: 6 },
  ...
  secondaryValue: { fontSize: 14, fontWeight: '600', color: colors.text },
  ...
  tripCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 10, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  tripInfo: { flex: 1 },
  tripPurpose: { fontSize: 15, fontWeight: '600', color: colors.text },
  tripDate: { fontSize: 12, color: '#666', marginTop: 2 },
  tripRight: { alignItems: 'flex-end' },
  tripMiles: { fontSize: 16, fontWeight: 'bold', color: colors.text },
  ...
  roundTripLabel: { fontSize: 15, color: colors.text },
});
