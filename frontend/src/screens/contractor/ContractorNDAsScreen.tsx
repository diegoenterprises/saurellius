...
const styles = StyleSheet.create({
  ...
  agreementCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 14, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  agreementTitle: { fontSize: 16, fontWeight: '600', color: colors.text },
  ...
  signText: { fontSize: 14, fontWeight: '600', color: colors.text },
