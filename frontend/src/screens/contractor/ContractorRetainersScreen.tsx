...
const styles = StyleSheet.create({
  ...
  retainerCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  clientInitial: { fontSize: 18, fontWeight: 'bold', color: colors.text },
  retainerInfo: { flex: 1 },
  ...
  usageValue: { fontSize: 12, color: colors.text, fontWeight: '600' },
  ...
  autoRenewText: { fontSize: 10, fontWeight: '600', color: colors.text },
