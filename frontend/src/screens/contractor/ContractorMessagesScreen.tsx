...
const styles = StyleSheet.create({
  ...
  filterChip: { paddingHorizontal: 16, paddingVertical: 8, borderRadius: 16, backgroundColor: colors.card, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  conversationItem: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.card, borderRadius: 12, padding: 14, marginBottom: 10, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  unreadText: { fontSize: 11, fontWeight: 'bold', color: colors.text },
  chatHeader: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.card, paddingHorizontal: 16, paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: '#2a2a4e' },
  ...
  messageBubbleOther: { backgroundColor: colors.card, borderBottomLeftRadius: 4 },
  senderName: { fontSize: 11, color: '#666', marginBottom: 4 },
  messageText: { fontSize: 14, color: colors.text, lineHeight: 20 },
  messageTextMe: { color: colors.text },
  messageTime: { fontSize: 10, color: '#666', marginTop: 4, alignSelf: 'flex-end' },
  messageTimeMe: { color: 'rgba(255,255,255,0.7)' },
  inputContainer: { flexDirection: 'row', alignItems: 'flex-end', padding: 12, backgroundColor: colors.card, borderTopWidth: 1, borderTopColor: '#2a2a4e' },
  attachButton: { padding: 8 },
  messageInput: { flex: 1, backgroundColor: colors.background, borderRadius: 20, paddingHorizontal: 16, paddingVertical: 10, fontSize: 15, color: colors.text, maxHeight: 100, marginHorizontal: 8 },
