...
const styles = StyleSheet.create({
  ...
  inputWrapper: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.card, borderRadius: 10, borderWidth: 1, borderColor: '#2a2a4e' },
  inputPrefix: { fontSize: 16, color: '#666', paddingLeft: 14 },
  inputSuffix: { fontSize: 16, color: '#666', paddingRight: 14 },
  input: { flex: 1, padding: 14, fontSize: 16, color: colors.text },
  inputFull: { backgroundColor: colors.card, borderRadius: 10, padding: 14, fontSize: 16, color: colors.text, borderWidth: 1, borderColor: '#2a2a4e' },
  resultsSection: { padding: 16 },
  breakdownCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  breakdownValue: { fontSize: 14, fontWeight: '500', color: colors.text },
  ...
  conversionsCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginTop: 14, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  conversionValue: { fontSize: 14, fontWeight: '600', color: colors.text },
  savedSection: { padding: 16 },
  savedCard: { flexDirection: 'row', justifyContent: 'space-between', backgroundColor: colors.card, borderRadius: 12, padding: 14, marginBottom: 10, borderWidth: 1, borderColor: '#2a2a4e' },
  savedInfo: {},
