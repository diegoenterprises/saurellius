...
const styles = StyleSheet.create({
  ...
  content: { flex: 1 },
  programCard: { backgroundColor: colors.card, borderRadius: 16, padding: 20, margin: 16, borderWidth: 2, borderColor: '#F59E0B30' },
  programHeader: { flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 10 },
  programTitle: { fontSize: 20, fontWeight: 'bold', color: colors.text },
  ...
  codeRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.background, borderRadius: 12, padding: 14 },
  ...
  shareText: { fontSize: 16, fontWeight: '600', color: colors.text },
  inviteSection: { paddingHorizontal: 16, marginBottom: 16 },
  sectionTitle: { fontSize: 16, fontWeight: '600', color: colors.text, marginBottom: 12 },
  inviteRow: { flexDirection: 'row', gap: 10 },
  inviteInput: { flex: 1, backgroundColor: colors.card, borderRadius: 12, padding: 14, fontSize: 15, color: colors.text, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  referralCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  referralInfo: { flex: 1 },
  referralName: { fontSize: 16, fontWeight: '600', color: colors.text },
  ...
  payoutButtonText: { fontSize: 14, fontWeight: '600', color: colors.text },
