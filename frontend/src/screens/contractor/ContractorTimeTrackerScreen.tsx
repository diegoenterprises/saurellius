...
const styles = StyleSheet.create({
  ...
  timerTask: { fontSize: 16, fontWeight: '600', color: colors.text, textAlign: 'center' },
  ...
  stopButtonText: { fontSize: 16, fontWeight: '600', color: colors.text },
  ...
  startButtonText: { fontSize: 16, fontWeight: '600', color: colors.text },
  statsRow: { flexDirection: 'row', backgroundColor: colors.card, marginHorizontal: 16, marginTop: 16, borderRadius: 12, padding: 14 },
  ...
  entryCard: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: colors.card, marginHorizontal: 16, marginBottom: 8, borderRadius: 12, padding: 14, borderWidth: 1, borderColor: '#2a2a4e' },
  entryLeft: { flexDirection: 'row', alignItems: 'center', flex: 1 },
  billableDot: { width: 8, height: 8, borderRadius: 4, marginRight: 12 },
  entryInfo: { flex: 1 },
  entryTask: { fontSize: 14, fontWeight: '500', color: colors.text },
  entryProject: { fontSize: 12, color: '#666', marginTop: 2 },
  entryTime: { fontSize: 11, color: '#a0a0a0', marginTop: 4 },
  entryRight: { alignItems: 'flex-end' },
  entryDuration: { fontSize: 15, fontWeight: '600', color: colors.text },
  ...
  durationInput: { flex: 1, flexDirection: 'row', alignItems: 'center', backgroundColor: colors.card, borderRadius: 10, borderWidth: 1, borderColor: '#2a2a4e' },
  durationField: { flex: 1, padding: 14, fontSize: 18, fontWeight: '600', color: colors.text, textAlign: 'center' },
  durationLabel: { fontSize: 14, color: '#666', paddingRight: 14 },
  billableToggle: { flexDirection: 'row', alignItems: 'center', gap: 10, marginTop: 8 },
  billableLabel: { fontSize: 15, color: colors.text },
});
