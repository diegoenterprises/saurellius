...
const styles = StyleSheet.create({
  ...
  milestoneCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  urgentCard: { borderColor: '#EF4444' },
  milestoneHeader: { flexDirection: 'row', justifyContent: 'space-between' },
  milestoneInfo: { flex: 1 },
  milestoneTitle: { fontSize: 16, fontWeight: '600', color: colors.text },
  ...
  deliverablesTitle: { fontSize: 13, fontWeight: '600', color: colors.text, marginBottom: 10 },
  ...
  submitText: { fontSize: 14, fontWeight: '600', color: colors.text },
