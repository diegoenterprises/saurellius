...
const styles = StyleSheet.create({
  ...
  content: { flex: 1 },
  section: { padding: 16 },
  equipCard: { backgroundColor: '#1a1a2e', borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  equipInfo: { flex: 1 },
  equipName: { fontSize: 16, fontWeight: '600', color: '#FFF' },
  ...
  valueAmount: { fontSize: 15, fontWeight: '600', color: '#FFF', marginTop: 2 },
