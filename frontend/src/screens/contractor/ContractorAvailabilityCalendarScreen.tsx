...
const styles = StyleSheet.create({
  ...
  navButton: { padding: 8 },
  weekRange: { fontSize: 16, fontWeight: '600', color: '#FFF' },
  ...
  dayColumn: { width: 80, marginHorizontal: 4, backgroundColor: '#1a1a2e', borderRadius: 12, padding: 8, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  todayText: { color: '#FFF' },
  dayNumber: { fontSize: 16, fontWeight: 'bold', color: '#FFF' },
  ...
  blockCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#1a1a2e', borderRadius: 12, padding: 14, marginBottom: 10, borderWidth: 1, borderColor: '#2a2a4e' },
  blockIndicator: { width: 4, height: '100%', borderRadius: 2, marginRight: 12 },
  blockInfo: { flex: 1 },
  blockTime: { fontSize: 14, fontWeight: '600', color: '#FFF' },
