...
const styles = StyleSheet.create({
  ...
  permitCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 14, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  permitInfo: { flex: 1 },
  permitNumber: { fontSize: 17, fontWeight: '600', color: colors.text },
  ...
  dateValue: { fontSize: 14, fontWeight: '500', color: colors.text, marginTop: 2 },
  renewButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: 14, paddingVertical: 10, borderRadius: 10, backgroundColor: colors.background, gap: 6 },
  renewText: { fontSize: 14, color: '#1473FF' },
  spotCard: { backgroundColor: colors.card, borderRadius: 12, padding: 14, marginBottom: 10, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  spotInfo: { flex: 1 },
  spotNumber: { fontSize: 16, fontWeight: '600', color: colors.text },
  ...
  reserveText: { fontSize: 14, fontWeight: '600', color: colors.text },
  ...
  requestText: { fontSize: 14, fontWeight: '600', color: colors.text },
});
