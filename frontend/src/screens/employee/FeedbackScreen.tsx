...
const styles = StyleSheet.create({
  ...
  feedbackCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  feedbackInfo: { flex: 1 },
  feedbackSubject: { fontSize: 15, fontWeight: '600', color: colors.text },
  ...
  typeOption: { width: '47%', backgroundColor: colors.card, borderRadius: 12, padding: 14, borderWidth: 2, borderColor: 'transparent', alignItems: 'center' },
  ...
  typeOptionName: { fontSize: 14, fontWeight: '600', color: colors.text },
  typeOptionNameActive: { color: '#1473FF' },
  typeOptionDesc: { fontSize: 11, color: '#666', marginTop: 2, textAlign: 'center' },
  anonymousRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.card, borderRadius: 12, padding: 14, marginTop: 8 },
  anonymousInfo: { flex: 1 },
  anonymousLabel: { fontSize: 15, fontWeight: '500', color: colors.text },
