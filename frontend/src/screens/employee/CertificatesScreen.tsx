...
const styles = StyleSheet.create({
  ...
  certCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  expiredCard: { opacity: 0.7 },
  certHeader: { flexDirection: 'row', alignItems: 'flex-start' },
  certIcon: { width: 48, height: 48, borderRadius: 12, backgroundColor: colors.background, justifyContent: 'center', alignItems: 'center', marginRight: 12 },
  certInfo: { flex: 1 },
  certName: { fontSize: 16, fontWeight: '600', color: colors.text },
