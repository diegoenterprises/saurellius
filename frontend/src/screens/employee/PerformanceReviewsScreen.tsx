...
const styles = StyleSheet.create({
  ...
  reviewInfo: { flex: 1 },
  reviewPeriod: { fontSize: 16, fontWeight: '600', color: colors.text },
  ...
  ratingValue: { fontSize: 14, fontWeight: '600', color: colors.text, marginLeft: 8 },
  ...
  goalsTitle: { fontSize: 13, fontWeight: '600', color: colors.text, marginBottom: 8 },
  ...
  feedbackTitle: { fontSize: 13, fontWeight: '600', color: colors.text, marginBottom: 8 },
