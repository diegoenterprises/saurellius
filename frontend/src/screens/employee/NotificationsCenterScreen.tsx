...
const styles = StyleSheet.create({
  ...
  notifCard: { flexDirection: 'row', alignItems: 'flex-start', backgroundColor: colors.card, borderRadius: 12, padding: 14, marginBottom: 10, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  notifTitle: { flex: 1, fontSize: 15, fontWeight: '600', color: colors.text },
