...
const styles = StyleSheet.create({
  ...
  jobCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  jobInfo: { flex: 1 },
  jobTitle: { fontSize: 17, fontWeight: '600', color: colors.text },
  ...
  applyText: { fontSize: 14, fontWeight: '600', color: colors.text },
