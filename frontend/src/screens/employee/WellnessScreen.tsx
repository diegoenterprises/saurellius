...
const styles = StyleSheet.create({
  ...
  activityCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.card, borderRadius: 12, padding: 14, marginBottom: 10, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  challengeCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  challengeName: { fontSize: 17, fontWeight: '600', color: colors.text, marginBottom: 4 },
