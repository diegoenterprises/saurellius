...
const styles = StyleSheet.create({
  ...
  faqCard: { backgroundColor: colors.card, borderRadius: 12, padding: 14, marginBottom: 10, borderWidth: 1, borderColor: '#2a2a4e' },
  faqHeader: { flexDirection: 'row', alignItems: 'center' },
  faqIcon: { width: 28, height: 28, borderRadius: 8, justifyContent: 'center', alignItems: 'center', marginRight: 10 },
  faqQuestion: { flex: 1, fontSize: 14, fontWeight: '500', color: colors.text },
  ...
  newTicketText: { fontSize: 14, fontWeight: '600', color: colors.text },
