...
const styles = StyleSheet.create({
  ...
  floorChip: { alignItems: 'center', paddingHorizontal: 16, paddingVertical: 8, borderRadius: 12, backgroundColor: colors.card, marginRight: 8, borderWidth: 1, borderColor: '#2a2a4e' },
  floorChipActive: { backgroundColor: '#1473FF', borderColor: '#1473FF' },
  floorNumber: { fontSize: 18, fontWeight: 'bold', color: '#666' },
  floorNumberActive: { color: colors.text },
  ...
  filterChip: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 14, backgroundColor: colors.card, marginRight: 8, gap: 4, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  locationCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  actionButton: { flexDirection: 'row', alignItems: 'center', padding: 10, backgroundColor: colors.background, borderRadius: 8, gap: 4 },
  actionText: { fontSize: 13, color: '#1473FF' },
  bookButton: { flex: 1, justifyContent: 'center', backgroundColor: '#10B981' },
  bookText: { fontSize: 13, fontWeight: '600', color: colors.text },
