...
const styles = StyleSheet.create({
  ...
  roleCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  levelText: { fontSize: 14, fontWeight: 'bold', color: colors.text },
  roleInfo: { flex: 1 },
  ...
  youText: { fontSize: 11, fontWeight: '600', color: colors.text },
  goalBadge: { padding: 8 },
  ...
  skillCard: { backgroundColor: colors.card, borderRadius: 12, padding: 14, marginBottom: 10, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  skillLevel: { fontSize: 12, color: colors.text, fontWeight: '500' },
