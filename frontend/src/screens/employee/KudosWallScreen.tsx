...
const styles = StyleSheet.create({
  ...
  kudosCard: { backgroundColor: colors.card, borderRadius: 16, padding: 16, marginBottom: 14, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  fromName: { fontSize: 14, fontWeight: '600', color: colors.text },
  ...
  toAvatarText: { fontSize: 12, fontWeight: 'bold', color: colors.text },
  toName: { fontSize: 14, fontWeight: '600', color: colors.text },
  toDept: { fontSize: 11, color: '#666' },
  kudosMessage: { fontSize: 15, color: colors.text, marginTop: 14, lineHeight: 22, fontStyle: 'italic' },
  ...
  giveButtonText: { fontSize: 16, fontWeight: '600', color: colors.text },
