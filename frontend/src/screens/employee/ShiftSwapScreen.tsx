...
const styles = StyleSheet.create({
  ...
  requestCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  employeeName: { fontSize: 16, fontWeight: '600', color: colors.text, marginBottom: 12 },
  shiftsComparison: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: colors.background, borderRadius: 12, padding: 12 },
  ...
  availableCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  availableEmployee: { fontSize: 15, fontWeight: '600', color: colors.text },
