...
const styles = StyleSheet.create({
  ...
  newsTitle: { flex: 1, fontSize: 16, fontWeight: '600', color: '#FFF', lineHeight: 22 },
  ...
  ackText: { fontSize: 13, fontWeight: '600', color: '#FFF' },
  acknowledgedBadge: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 6 },
  acknowledgedText: { fontSize: 13, color: '#10B981' },
  actionButtons: { flexDirection: 'row', gap: 8 },
  actionButton: { width: 40, height: 40, borderRadius: 10, backgroundColor: '#0f0f23', justifyContent: 'center', alignItems: 'center' },
