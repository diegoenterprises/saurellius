...
const styles = StyleSheet.create({
  ...
  claimCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  claimInfo: { flex: 1 },
  claimDescription: { fontSize: 15, fontWeight: '600', color: colors.text },
  claimCategory: { fontSize: 12, color: '#666', marginTop: 2 },
  claimRight: { alignItems: 'flex-end' },
  claimAmount: { fontSize: 16, fontWeight: 'bold', color: colors.text },
