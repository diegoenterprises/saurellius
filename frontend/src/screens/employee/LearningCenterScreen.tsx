...
const styles = StyleSheet.create({
  ...
  courseCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  courseTitle: { fontSize: 17, fontWeight: '600', color: colors.text, marginBottom: 6 },
