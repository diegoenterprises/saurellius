...
export default function EmployeePayrollRulesScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}> 
      <ScrollView contentContainerStyle={styles.content}>
        <Text style={[styles.title, { color: colors.text }]}>Tax Rules (Employee)</Text>
        <Text style={[styles.subtitle, { color: colors.textSecondary }]}>Live IRS federal withholding rules (2026). W-4 wizard references these.</Text>
