...
const styles = StyleSheet.create({
  ...
  surveyInfo: { flex: 1 },
  surveyTitle: { fontSize: 16, fontWeight: '600', color: '#FFF' },
  ...
  resultCard: { backgroundColor: '#1a1a2e', borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  resultHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' },
  resultTitle: { fontSize: 16, fontWeight: '600', color: '#FFF', flex: 1 },
  ...
  resultStatValue: { fontSize: 20, fontWeight: 'bold', color: '#FFF' },
  ...
  highlightValue: { fontSize: 12, fontWeight: '600', color: '#FFF' },
