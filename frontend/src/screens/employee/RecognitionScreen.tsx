...
const styles = StyleSheet.create({
  ...
  recCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  recMessage: { fontSize: 15, color: colors.text, marginTop: 12, lineHeight: 22 },
  ...
  badgeCard: { width: '47%', backgroundColor: colors.card, borderRadius: 14, padding: 16, alignItems: 'center', borderWidth: 1, borderColor: '#2a2a4e' },
