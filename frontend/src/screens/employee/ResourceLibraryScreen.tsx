...
const styles = StyleSheet.create({
  ...
  content: { flex: 1 },
  section: { padding: 16 },
  resourceCard: { backgroundColor: '#1a1a2e', borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  newText: { fontSize: 9, fontWeight: 'bold', color: '#FFF' },
  ...
  resourceInfo: { flex: 1 },
  resourceTitle: { fontSize: 16, fontWeight: '600', color: '#FFF' },
