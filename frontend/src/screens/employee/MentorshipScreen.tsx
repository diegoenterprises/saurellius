...
const styles = StyleSheet.create({
  ...
  relationCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  goalText: { flex: 1, fontSize: 13, color: colors.text },
  ...
  matchCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
