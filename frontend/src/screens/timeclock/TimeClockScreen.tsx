...
const createStyles = (isDarkMode: boolean) => StyleSheet.create({
  ...
  clockInText: { color: colors.text, fontSize: 18, fontWeight: 'bold', marginTop: 8, letterSpacing: 2 },
  ...
  breakButtonText: { color: colors.text, fontWeight: '600' },
  ...
  endBreakText: { color: colors.text, fontWeight: '600', fontSize: 16 },
  ...
  clockOutText: { color: colors.text, fontWeight: '600', fontSize: 16 },
