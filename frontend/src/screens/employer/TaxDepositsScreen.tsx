...
const styles = StyleSheet.create({
  ...
  depositCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  depositInfo: { flex: 1 },
  depositType: { fontSize: 15, fontWeight: '600', color: colors.text },
