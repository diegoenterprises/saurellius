...
const styles = StyleSheet.create({
  ...
  checkoutCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  equipmentName: { fontSize: 16, fontWeight: '600', color: colors.text },
  ...
  employeeInfo: {},
  employeeName: { fontSize: 14, fontWeight: '500', color: colors.text },
  ...
  dateValue: { fontSize: 11, fontWeight: '500', color: colors.text },
  ...
  checkinText: { fontSize: 14, fontWeight: '600', color: colors.text },
