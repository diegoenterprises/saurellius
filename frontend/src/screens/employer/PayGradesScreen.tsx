...
const styles = StyleSheet.create({
  ...
  gradeCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  gradeInfo: { flex: 1 },
  gradeName: { fontSize: 16, fontWeight: '600', color: colors.text },
