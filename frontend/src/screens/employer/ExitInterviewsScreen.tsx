...
const styles = StyleSheet.create({
  ...
  interviewCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  feedbackSection: { marginTop: 12, padding: 12, backgroundColor: colors.background, borderRadius: 10 },
  ...
  actionButton: { flexDirection: 'row', alignItems: 'center', paddingVertical: 10, paddingHorizontal: 14, backgroundColor: colors.background, borderRadius: 8, gap: 6 },
  scheduleButton: { flex: 1, justifyContent: 'center', backgroundColor: '#F59E0B' },
  scheduleText: { fontSize: 14, fontWeight: '600', color: colors.text },
  conductButton: { flex: 1, justifyContent: 'center', backgroundColor: '#10B981' },
  conductText: { fontSize: 14, fontWeight: '600', color: colors.text },
