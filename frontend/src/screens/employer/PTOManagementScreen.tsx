...
const styles = StyleSheet.create({
  ...
  hoursBox: { alignItems: 'center', backgroundColor: colors.background, paddingHorizontal: 12, paddingVertical: 8, borderRadius: 10 },
  hoursValue: { fontSize: 18, fontWeight: 'bold', color: colors.text },
  ...
  policyValue: { fontSize: 14, fontWeight: '500', color: colors.text, marginTop: 2 },
