...
const styles = StyleSheet.create({
  ...
  selectionText: { fontSize: 14, color: '#FFF' },
  ...
  sectionTitle: { fontSize: 14, fontWeight: '600', color: '#FFF', marginHorizontal: 16, marginTop: 16, marginBottom: 10 },
  actionsScroll: { paddingHorizontal: 16 },
  actionCard: { width: 130, backgroundColor: '#1a1a2e', borderRadius: 12, padding: 14, marginRight: 10, borderWidth: 2, borderColor: 'transparent' },
  ...
  actionName: { fontSize: 13, fontWeight: '600', color: '#FFF' },
  actionDesc: { fontSize: 10, color: '#666', marginTop: 4, lineHeight: 14 },
  actionConfig: { marginHorizontal: 16, marginTop: 12, backgroundColor: '#1a1a2e', borderRadius: 12, padding: 14 },
  inputRow: { marginBottom: 12 },
  inputLabel: { fontSize: 12, color: '#a0a0a0', marginBottom: 6 },
  valueInput: { backgroundColor: '#0f0f23', borderRadius: 8, padding: 12, fontSize: 16, color: '#FFF', borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  executeText: { fontSize: 15, fontWeight: '600', color: '#FFF' },
  employeeList: { flex: 1, paddingHorizontal: 16 },
  employeeCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#1a1a2e', borderRadius: 12, padding: 14, marginBottom: 8, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  employeeInfo: { flex: 1 },
  employeeName: { fontSize: 15, fontWeight: '600', color: '#FFF' },
