...
const styles = StyleSheet.create({
  ...
  visitorCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  hostName: { fontSize: 13, fontWeight: '500', color: colors.text },
  ...
  checkoutText: { fontSize: 14, fontWeight: '600', color: colors.text },
