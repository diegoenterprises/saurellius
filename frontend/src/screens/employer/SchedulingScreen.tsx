...
const styles = StyleSheet.create({
  ...
  navButton: { padding: 8 },
  weekRange: { fontSize: 16, fontWeight: '600', color: colors.text, marginHorizontal: 12 },
  todayButton: { backgroundColor: '#1473FF', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 12, marginLeft: 12 },
  todayText: { fontSize: 12, fontWeight: '600', color: colors.text },
  scheduleGrid: { flex: 1, paddingHorizontal: 8 },
  dayColumn: { width: 140, marginHorizontal: 4, marginTop: 12 },
  dayHeader: { alignItems: 'center', backgroundColor: colors.card, borderRadius: 10, padding: 10, marginBottom: 8 },
  dayName: { fontSize: 12, color: '#a0a0a0' },
  dayDate: { fontSize: 20, fontWeight: 'bold', color: colors.text, marginTop: 2 },
  coverageDot: { width: 8, height: 8, borderRadius: 4, marginTop: 6 },
  shiftsColumn: { maxHeight: 350 },
  shiftCard: { backgroundColor: colors.card, borderRadius: 8, padding: 10, marginBottom: 6, borderLeftWidth: 3 },
  shiftTime: { fontSize: 11, fontWeight: '600', color: '#1473FF' },
  shiftEmployee: { fontSize: 13, fontWeight: '500', color: colors.text, marginTop: 4 },
  ...
  detailCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16 },
