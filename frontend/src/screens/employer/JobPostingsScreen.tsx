...
const styles = StyleSheet.create({
  ...
  content: { flex: 1 },
  section: { padding: 16 },
  postingCard: { backgroundColor: '#1a1a2e', borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  postingHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' },
  postingInfo: { flex: 1 },
  postingTitle: { fontSize: 17, fontWeight: '600', color: '#FFF' },
  ...
  statValue: { fontSize: 15, fontWeight: '600', color: '#FFF' },
