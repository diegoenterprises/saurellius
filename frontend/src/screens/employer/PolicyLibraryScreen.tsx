...
const styles = StyleSheet.create({
  ...
  statCardValue: { fontSize: 16, fontWeight: 'bold', color: colors.text },
  ...
  policyInfo: { flex: 1 },
  policyTitle: { fontSize: 16, fontWeight: '600', color: colors.text },
  ...
  ackValue: { fontSize: 12, fontWeight: '600', color: colors.text },
  ...
  remindText: { fontSize: 13, fontWeight: '600', color: colors.text },
