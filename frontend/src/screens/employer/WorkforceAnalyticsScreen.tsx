...
const styles = StyleSheet.create({
  ...
  metricCard: { flex: 1, backgroundColor: '#1a1a2e', borderRadius: 12, padding: 12, marginHorizontal: 4, alignItems: 'center', borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  sectionCard: { backgroundColor: '#1a1a2e', borderRadius: 14, padding: 16, marginHorizontal: 16, marginTop: 16, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  deptInfo: { width: 100 },
  deptName: { fontSize: 13, color: '#FFF' },
