...
const styles = StyleSheet.create({
  ...
  scoreCircle: { width: 80, height: 80, borderRadius: 40, backgroundColor: '#0f0f23', justifyContent: 'center', alignItems: 'center', marginRight: 16 },
  ...
  scoreStatValue: { fontSize: 18, fontWeight: 'bold', color: '#FFF' },
  ...
  categoryChip: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 14, paddingVertical: 8, borderRadius: 16, backgroundColor: '#1a1a2e', marginRight: 8, gap: 6, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  content: { flex: 1 },
  section: { padding: 16 },
  itemCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#1a1a2e', borderRadius: 12, padding: 14, marginBottom: 10, borderWidth: 1, borderColor: '#2a2a4e' },
