...
const styles = StyleSheet.create({
  ...
  nodeInfo: { flex: 1 },
  nodeName: { fontSize: 14, fontWeight: '600', color: '#FFF' },
  ...
  detailPanel: { position: 'absolute', bottom: 0, left: 0, right: 0, backgroundColor: '#1a1a2e', borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 20, borderTopWidth: 1, borderTopColor: '#2a2a4e' },
  ...
  detailAvatarText: { fontSize: 18, fontWeight: 'bold', color: '#FFF' },
  detailInfo: { flex: 1 },
  detailName: { fontSize: 18, fontWeight: '600', color: '#FFF' },
