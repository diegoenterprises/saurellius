...
const styles = StyleSheet.create({
  ...
  cycleCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  activeCycle: { borderColor: '#1473FF' },
  cycleHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' },
  cycleName: { fontSize: 16, fontWeight: '600', color: colors.text },
  ...
  cycleStatValue: { fontSize: 15, fontWeight: '600', color: colors.text },
  cycleStatLabel: { fontSize: 10, color: '#666', marginTop: 2 },
  adjustmentCard: { backgroundColor: colors.card, borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#2a2a4e' },
  adjHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' },
  adjInfo: { flex: 1 },
  adjName: { fontSize: 16, fontWeight: '600', color: colors.text },
  ...
  salaryValue: { fontSize: 16, fontWeight: '600', color: colors.text, marginTop: 2 },
