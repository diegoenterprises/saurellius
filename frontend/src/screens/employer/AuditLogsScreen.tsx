...
const styles = StyleSheet.create({
  ...
  logCard: { backgroundColor: colors.card, borderRadius: 12, padding: 14, marginBottom: 10, borderWidth: 1, borderColor: '#2a2a4e' },
  ...
  expandedValue: { fontSize: 12, color: colors.text },
  detailsSection: { marginTop: 10, backgroundColor: colors.background, borderRadius: 8, padding: 10 },
  detailsTitle: { fontSize: 12, fontWeight: '600', color: colors.text, marginBottom: 6 },
