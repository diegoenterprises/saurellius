...
const styles = StyleSheet.create({
  ...
  kpiCard: { width: (width - 40) / 2, backgroundColor: '#1a1a2e', borderRadius: 12, padding: 14, alignItems: 'center' },
  ...
  summaryCard: { backgroundColor: '#1a1a2e', marginHorizontal: 16, borderRadius: 14, padding: 16, marginBottom: 12 },
  ...
  summaryValue: { fontSize: 18, fontWeight: 'bold', color: '#FFF', marginTop: 4 },
  chartCard: { backgroundColor: '#1a1a2e', marginHorizontal: 16, borderRadius: 14, padding: 16, marginBottom: 12 },
  ...
  sectionCard: { backgroundColor: '#1a1a2e', marginHorizontal: 16, borderRadius: 14, padding: 16, marginBottom: 12 },
  deptRow: { marginBottom: 14 },
  deptInfo: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  deptName: { fontSize: 14, fontWeight: '500', color: '#FFF' },
  ...
  earnerInfo: { flex: 1 },
  earnerName: { fontSize: 14, fontWeight: '500', color: '#FFF' },
  ...
  metricCard: { flex: 1, backgroundColor: '#1a1a2e', borderRadius: 14, padding: 16, alignItems: 'center' },
