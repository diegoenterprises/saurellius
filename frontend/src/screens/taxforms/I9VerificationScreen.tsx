...
const createStyles = (isDarkMode: boolean) => StyleSheet.create({
  ...
  listOr: { marginLeft: 12, paddingHorizontal: 8, paddingVertical: 2, backgroundColor: '#6366F1', borderRadius: 4, color: colors.text, fontSize: 10, fontWeight: 'bold' },
  andLabel: { marginLeft: 12, paddingHorizontal: 8, paddingVertical: 2, backgroundColor: '#10B981', borderRadius: 4, color: colors.text, fontSize: 10, fontWeight: 'bold' },
